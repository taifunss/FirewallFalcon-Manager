...
#!/bin/bash
# FirewallFalcon limiter version 2026-04-09.1
...
while true; do
    ...
    while IFS=: read -r user pass expiry limit bandwidth_gb _extra; do
        ...
        if (( online_count > limit )); then
            # POPRAWKA: zapisz ban do logu niezależnie od stanu user_locked
            # (wcześniej ban nie był logowany jeśli konto było już zablokowane)
...
sync_runtime_components_if_needed() {
    local limiter_marker="# FirewallFalcon limiter version 2026-04-09.1"
