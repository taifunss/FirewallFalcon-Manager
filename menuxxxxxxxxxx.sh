...
while true; do
    ...
    while IFS=: read -r user pass expiry limit bandwidth_gb _extra; do
        ...
        if $dynamic_banners_enabled; then
            ...
            banner_content+="<font color=\"white\">📅 <b>Wazne do :</b> $expiry ($days_left)</font><br>"
            banner_content+="<font color=\"white\">📊 <b>Ilosc GB  :</b> $bw_info</font><br>"
            banner_content+="<font color=\"white\">🔌 <b>Podlaczone urzadzenia   :</b> $online_count/$limit</font><br><br>"
