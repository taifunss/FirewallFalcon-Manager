...
#!/bin/bash
# FirewallFalcon limiter version 2026-04-10.3
...
sync_runtime_components_if_needed() {
    local limiter_marker="# FirewallFalcon limiter version 2026-04-10.3"
